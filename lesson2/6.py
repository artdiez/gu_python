...
size = int(input("Введите количество добавляемого товара: "))
i = 1
product = []
nomenclature = []
...
while i <= size:
    product = dict({'Название': input("Укажите название товара: "), 'Цена': input("Введите цену товара: "),
                    'Количество': input('Введите количество товара: '), 'ед': input("Введите единицу измерения товара: ")})
    nomenclature.append((i, product))
    analytics['название'].append(product.get('Название'))
    analytics['цена'].append(product.get('Цена'))
    analytics['количество'].append(product.get('Количество'))
    analytics['ед'].append(product.get('ед'))
    i += 1
